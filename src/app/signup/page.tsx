          ...
          <form action="">
            ...
            <div className="flex flex-col justify-center items-center">
              <p className="text-md text-black/70 dark:text-white/70 mb-2 text-center font-extralight">
                Join Light and start sharing your moments!
              </p>
            </div>
            ...
            <div className="flex flex-col justify-center items-center">
              <button 
                type="submit"
                className="py-2 text-white rounded-full shadow-lg backdrop-blur-xl bg-blue-500
                          hover:bg-blue-600 hover:scale-101 transition-all duration-300 
                            md:text-xl w-full mt-5">Sign Up
              </button>
            </div>
